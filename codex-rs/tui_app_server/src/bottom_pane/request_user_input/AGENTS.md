...
This file applies to `codex-rs/tui_app_server/src/bottom_pane/request_user_input/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
