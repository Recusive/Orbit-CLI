# codex-rs/skills/src/assets/samples/skill-installer/agents/

This file applies to `codex-rs/skills/src/assets/samples/skill-installer/agents/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
...
Agent configuration for the skill-installer skill.

### Key files

- `openai.yaml` -- agent definition for the skill installation workflow.
