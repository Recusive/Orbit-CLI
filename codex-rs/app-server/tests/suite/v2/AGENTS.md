...
This file applies to `codex-rs/app-server/tests/suite/v2/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
