...
This file applies to `codex-rs/core/src/tasks/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
