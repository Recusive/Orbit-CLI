# codex-rs/apply-patch/tests/fixtures/scenarios/004_move_to_new_directory/expected/

This file applies to `codex-rs/apply-patch/tests/fixtures/scenarios/004_move_to_new_directory/expected/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
