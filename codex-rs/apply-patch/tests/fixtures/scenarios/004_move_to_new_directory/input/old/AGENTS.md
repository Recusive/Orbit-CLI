# codex-rs/apply-patch/tests/fixtures/scenarios/004_move_to_new_directory/input/old/

This file applies to `codex-rs/apply-patch/tests/fixtures/scenarios/004_move_to_new_directory/input/old/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
...
Input subdirectory for scenario 004. Contains `name.txt` (source file for the move operation) and `other.txt` (unchanged).
