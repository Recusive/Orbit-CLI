# codex-rs/apply-patch/tests/fixtures/scenarios/004_move_to_new_directory/input/

This file applies to `codex-rs/apply-patch/tests/fixtures/scenarios/004_move_to_new_directory/input/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
