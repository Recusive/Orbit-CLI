# codex-rs/apply-patch/tests/fixtures/scenarios/002_multiple_operations/expected/

This file applies to `codex-rs/apply-patch/tests/fixtures/scenarios/002_multiple_operations/expected/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
