# codex-rs/apply-patch/tests/fixtures/scenarios/002_multiple_operations/input/

This file applies to `codex-rs/apply-patch/tests/fixtures/scenarios/002_multiple_operations/input/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
