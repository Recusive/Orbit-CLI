# codex-rs/apply-patch/tests/fixtures/scenarios/016_pure_addition_update_chunk/expected/

This file applies to `codex-rs/apply-patch/tests/fixtures/scenarios/016_pure_addition_update_chunk/expected/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
...
Expected filesystem state after the pure-addition patch.
Contains `input.txt` with the added lines appended.
