# codex-rs/apply-patch/tests/fixtures/scenarios/016_pure_addition_update_chunk/

This file applies to `codex-rs/apply-patch/tests/fixtures/scenarios/016_pure_addition_update_chunk/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
