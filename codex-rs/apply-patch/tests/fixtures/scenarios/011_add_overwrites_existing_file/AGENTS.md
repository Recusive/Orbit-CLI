...
This file applies to `codex-rs/apply-patch/tests/fixtures/scenarios/011_add_overwrites_existing_file/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
