# codex-rs/apply-patch/tests/fixtures/scenarios/011_add_overwrites_existing_file/expected/

This file applies to `codex-rs/apply-patch/tests/fixtures/scenarios/011_add_overwrites_existing_file/expected/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
...
Expected filesystem state after the add-overwrites patch.
Contains `duplicate.txt` with "new content", overwriting the original.
