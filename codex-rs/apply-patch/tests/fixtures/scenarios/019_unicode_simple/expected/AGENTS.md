# codex-rs/apply-patch/tests/fixtures/scenarios/019_unicode_simple/expected/

This file applies to `codex-rs/apply-patch/tests/fixtures/scenarios/019_unicode_simple/expected/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
