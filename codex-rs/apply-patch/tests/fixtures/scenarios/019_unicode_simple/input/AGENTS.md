# codex-rs/apply-patch/tests/fixtures/scenarios/019_unicode_simple/input/

This file applies to `codex-rs/apply-patch/tests/fixtures/scenarios/019_unicode_simple/input/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
...
Initial filesystem state for scenario 019_unicode_simple.
Contains `foo.txt` with Unicode content (accented characters).
