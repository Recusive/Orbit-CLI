# codex-rs/apply-patch/tests/fixtures/scenarios/003_multiple_chunks/input/

This file applies to `codex-rs/apply-patch/tests/fixtures/scenarios/003_multiple_chunks/input/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
...
Initial filesystem state for scenario 003_multiple_chunks.
Contains `multi.txt` with four lines (line1 through line4).
