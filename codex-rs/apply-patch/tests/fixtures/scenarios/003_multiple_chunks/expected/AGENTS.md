# codex-rs/apply-patch/tests/fixtures/scenarios/003_multiple_chunks/expected/

This file applies to `codex-rs/apply-patch/tests/fixtures/scenarios/003_multiple_chunks/expected/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
...
Expected filesystem state after applying the 003_multiple_chunks patch.
Contains `multi.txt` with "line2" and "line4" replaced by "changed2" and "changed4".
