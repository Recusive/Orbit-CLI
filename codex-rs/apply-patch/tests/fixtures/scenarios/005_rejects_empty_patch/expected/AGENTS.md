# codex-rs/apply-patch/tests/fixtures/scenarios/005_rejects_empty_patch/expected/

This file applies to `codex-rs/apply-patch/tests/fixtures/scenarios/005_rejects_empty_patch/expected/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
...
Expected filesystem state after the empty patch is rejected.
Contains `foo.txt`, identical to the input -- no changes applied.
