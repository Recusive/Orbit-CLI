# codex-rs/apply-patch/tests/fixtures/scenarios/005_rejects_empty_patch/

This file applies to `codex-rs/apply-patch/tests/fixtures/scenarios/005_rejects_empty_patch/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
