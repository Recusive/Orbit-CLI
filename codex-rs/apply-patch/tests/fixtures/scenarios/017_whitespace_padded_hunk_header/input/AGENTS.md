# codex-rs/apply-patch/tests/fixtures/scenarios/017_whitespace_padded_hunk_header/input/

This file applies to `codex-rs/apply-patch/tests/fixtures/scenarios/017_whitespace_padded_hunk_header/input/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
...
Initial filesystem state for scenario 017_whitespace_padded_hunk_header.
Contains `foo.txt` with content "old".
