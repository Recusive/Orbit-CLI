# codex-rs/apply-patch/tests/fixtures/scenarios/006_rejects_missing_context/input/

This file applies to `codex-rs/apply-patch/tests/fixtures/scenarios/006_rejects_missing_context/input/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
...
Initial filesystem state for scenario 006_rejects_missing_context.
Contains `modify.txt` with lines that do not match the patch's old lines.
