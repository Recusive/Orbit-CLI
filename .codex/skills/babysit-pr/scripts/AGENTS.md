# .codex/skills/babysit-pr/scripts/

This file applies to `.codex/skills/babysit-pr/scripts/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
...
- Scripts in this subtree should stay deterministic and self-contained; avoid baking in machine-specific paths unless the skill explicitly requires them.
