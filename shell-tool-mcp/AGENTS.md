...
This file applies to `shell-tool-mcp/` and its descendants. Follow the repo root `AGENTS.md` first, then use the local rules below when you edit this subtree.
